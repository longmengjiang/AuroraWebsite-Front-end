      ...
      <div class="sideBar">
        <div class="prevMeeting">
          ...
          <div class="allDescribe">
            <div class="describe">
              <div class="ch_des">新建</div>
              <div class="en_des">Newly Built</div>
            </div>
            <div class="describe">
              <div class="ch_des">往届会议</div>
              <div class="en_des">Previous sessions</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="meetingLeave">
          ...
          <div class="reason">
            <textarea
              ...
              maxlength="500"
              placeholder="提供请假的时间和理由........"
            ></textarea>
          </div>

          <!-- 上传按钮 -->
          <el-button class="pushBtn">上传</el-button>
        </div>
      </div>
    </div>
  </div>
